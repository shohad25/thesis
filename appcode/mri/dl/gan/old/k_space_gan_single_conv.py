...
class KSpaceSuperResolutionGAN(BasicModel):
    ...
    def __G__(self):
        ...
        with tf.name_scope('real'):
            ...
            self.conv_2, reg_2 = ops.conv2d_transpose(self.relu_1, output_shape=out_shape, k_h=3, k_w=3, d_h=2, d_w=1, name="G_conv_2")
        ...
        with tf.name_scope('imaginary'):
            ...
            out_dim = 16
            out_shape = [self.batch_size, self.dims_out[0], self.dims_out[1], out_dim]
            self.conv_22, reg_22 = ops.conv2d_transpose(self.relu_11, output_shape=out_shape, k_h=3, k_w=3, d_h=2, d_w=1, name="G_conv_22")
