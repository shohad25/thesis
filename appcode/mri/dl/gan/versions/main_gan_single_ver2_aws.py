...
from appcode.mri.dl.gan.versions.k_space_gan_single_ver2 import KSpaceSuperResolutionGAN
...
base_dir = '/home/ubuntu/ohadsh/data/'
...
def load_graph():
    ...
    tf.add_to_collection("placeholders", x_input['real'])
    tf.add_to_collection("placeholders", x_input['imag'])
