...
class KSpaceSuperResolutionWGAN(BasicModel):
    ...
    def __G__(self):
        ...
        noise_real = mask_not * tf.random_normal(shape=tf.shape(x_real), mean=mean_g, stddev=std_g, dtype=tf.float32,
                                                 seed=None, name='z_real')
        noise_imag = mask_not * tf.random_normal(shape=tf.shape(x_real), mean=mean_g, stddev=std_g, dtype=tf.float32,
                                                 seed=None, name='z_imag')
