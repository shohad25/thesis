...
class KSpaceSuperResolutionGAN(BasicModel):
    ...
    def __G__(self):
        ...
        # Model convolutions
        out_dim = 8
        self.conv_1, reg_1 = ops.conv2d(self.x_input_upscale, output_dim=out_dim, k_h=5, k_w=5, d_h=1, d_w=1, name="G_conv_1")
        ...
        out_dim = 8
        self.conv_2, reg_2 = ops.conv2d(self.x_input_upscale, output_dim=out_dim, k_h=3, k_w=3, d_h=1, d_w=1, name="G_conv_2")
