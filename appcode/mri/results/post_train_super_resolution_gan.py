...
if __name__ == '__main__':
    ...
    predict_paths = ['/sheard/googleDrive/Master/runs/factor_2_phase/gan/2017_02_10/000000.predict.bin',
                    '/sheard/googleDrive/Master/runs/factor_2_phase/gan/2017_02_10/000000.interp.bin']

    # predict_paths = ['/media/ohadsh/sheard/googleDrive/Master/runs/factor_2_phase/multi_channel/2017_01_23.bkp/000000.predict.bin',
    #                 '/media/ohadsh/sheard/googleDrive/Master/runs/factor_2_phase/multi_channel/2017_01_23.bkp/000000.interp.bin']
    w = 256
    h = 256
    tt = 'train'
    show = False
