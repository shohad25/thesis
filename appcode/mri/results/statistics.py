...
def post_train_2v(data_dir, predict_paths, h=256, w=256, tt='test', show=False, keep_center=None, DIMS_IN=None, DIMS_OUT=None, sampling_factor=None):
    ...
    while batches < 10:
        ...
        for i in range(0, real_p[name_1].shape[0]):
        ...
        error_zero_all.append(error_zero / float(real_p[name_1].shape[0]))
        error_interp_all.append(error_interp / float(real_p[name_1].shape[0]))
        error_proposed_all.append(error_proposed / float(real_p[name_1].shape[0]))
